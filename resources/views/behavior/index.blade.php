                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('behaviors.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('behaviors.destroy',$behavior->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('behaviors.show',$behavior->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
